	...
	public static void main(String[] args) {
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				String dataType = "";
				if (currentRow.getCell(1).toString().contains("Text"))
					dataType = "String";
				else if (currentRow.getCell(1).toString().contains("Numeric"))
					dataType = "int";
				else if (currentRow.getCell(1).toString().contains("Date"))
					dataType = "LocalDate";
